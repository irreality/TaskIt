...
// AppDelegate is used for calling functions when the app enters the background, or enters the foreground !!! E.g. saving settings upon closing.


import UIKit
import CoreData
// Getting functionality in CoreData framework, which was added to the project.
